...
"undefined" == typeof Haravan && (Haravan = {}), Haravan.cultures = [{
	...
	if (jQuery.isArray(a) || a.jquery) jQuery.each(a, function () {
		...
		for (var n in a) Haravan.buildParams(n, a[n], t);
...
Haravan.cultures = [{
	...
	if (this.multiSelector = t, this.values = r, this.index = e, this.name = a, this.element = document.createElement("select"), void 0 != this.values)
